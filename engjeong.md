...
![](engjeong_files/figure-markdown_github/unnamed-chunk-12-1.png) •5년 단위로 그룹화한 그래프를 보면 더욱 직관적으로 알 수 있다.
...
![](engjeong_files/figure-markdown_github/unnamed-chunk-13-1.png) •수도권,충청권, 영남권에 대체로 남성 종사자의 비율이 높게 나온다.
...
![](engjeong_files/figure-markdown_github/unnamed-chunk-14-1.png) •강원권의 경우 남성비율에 있어서는 별다른 차이가 없었지만 지역별 회사연수를 비교해보았을때 새로 지어진 회사비율이 많았다. 따라서 강원권의 큰 변동폭의 원인을 회사의 경과년수에서 찾을 수 있다.
